...
Mᴇꜱꜱᴀɢᴇ : <b>{}</b>"""
    ...
    CAPTION = """<b><a href="https://t.me/moviehub4u_update">{file_name}</a></b>\n\n<b>⚜️ Powered By : <a https://t.me/dreamcinezone>[moviehub4u_update]</a></b>"""
...
‼️ 𝑨𝒇𝒕𝒆𝒓 𝑺𝒆𝒏𝒅𝒊𝒏𝒈 𝑨 𝑺𝒄𝒓𝒆𝒆𝒏𝒔𝒉𝒐𝒕 𝑷𝒍𝒆𝒂𝒔𝒆 𝑮𝒊𝒗𝒆 𝒖𝒔 𝒔𝒐𝒎𝒆 𝑻𝒊𝒎𝒆 𝑻𝒐 𝑨𝒅𝒅 𝒀𝒐𝒖 𝑰𝒏 𝑻𝒉𝒆 𝑷𝒓𝒆𝒎𝒊𝒖𝒎 𝑳𝒊𝒔𝒕.</b>"""    
    ...
    SOURCE_TXT ="""<b>⚜ Ɲ 么 ʀ ᴜ Ƭ͢ ᴏ メ ⚜ </b>

✰ 𝙼𝚈 ✰ ⚜ Oωner ⚜  :<a href=https://t.me/dvl_naruto_06>Ɲ 么 ʀ ᴜ Ƭ͢ ᴏ メ 𓆩 ᵘᶻᵘᵐᵃᵏⁱ 𓆪</a>\n """
